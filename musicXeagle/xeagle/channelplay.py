# EagleMusic (Telegram bot project)
...
from musicXeagle.helpers.gets import get_file_name
from musicXeagle.xeagle.play import arq, cb_admin_check, generate_cover
from musicXeagle.services.callsmusic import callsmusic
...
from musicXeagle.services.queues import queues
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/67a673419b672dbc3da02.jpg"
...
async def jiosaavn(client: Client, message_: Message):
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @Eagle_Xrobot to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
    ...
    try:
        ...
        sthumb = "https://telegra.ph/file/5dd3d6d64ccd785ae5af2.jpg"
